...
class ReportGenerator:
    ...
    def generate_html_report(self, summary: Dict) -> str:
        ...
        # Calculate productivity metrics with AI if available
        productive_categories = ['Development', 'Office', 'Productivity', 'Education', 'Design']
        ...
        # Try AI-powered productivity analysis
        ai_insights = None
        try:
...
<body>
    <div class="container">
        ...
        {f'''<div class="section">
            ...
            <div style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%); padding: 25px; border-radius: 12px; border: 2px solid rgba(102, 126, 234, 0.3);">
                <div style="margin-bottom: 25px;">
                    <h3 style="color: #667eea; margin-bottom: 10px;">📊 Productivity Level: {ai_insights["productivity_level"]}</h3>
                    <p style="font-size: 14px; opacity: 0.8;">Based on AI analysis of your work patterns and focus time</p>
                </div>
                
                <div style="margin-bottom: 25px;">
                    <h3 style="color: #2d3748; margin-bottom: 15px; font-size: 18px;">💡 Key Insights:</h3>
                    <ul style="list-style: none; padding: 0;">
                        {"".join(f'<li style="padding: 10px 0; border-bottom: 1px solid rgba(0,0,0,0.05);">• {insight}</li>' for insight in ai_insights["insights"])}
                    </ul>
                </div>
                
                <div>
                    <h3 style="color: #2d3748; margin-bottom: 15px; font-size: 18px;">🚀 Recommendations:</h3>
                    <ul style="list-style: none; padding: 0;">
                        {"".join(f'<li style="padding: 10px 0; border-bottom: 1px solid rgba(0,0,0,0.05);">→ {rec}</li>' for rec in ai_insights["recommendations"])}
                    </ul>
                </div>
            </div>
        </div>''' if ai_insights else ''}
        
        <div class="footer">
            Generated by Goalin{' with AI Analysis' if ai_insights else ''} • {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}
        </div>
    </div>
</body>
</html>
